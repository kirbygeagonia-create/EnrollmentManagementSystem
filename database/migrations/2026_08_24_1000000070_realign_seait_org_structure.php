...
return new class extends Migration
{
    ...
    {
        // Raw MySQL-only ALTER/UPDATE statements. On SQLite (the default test
        // driver) ALTER ... MODIFY is invalid syntax; the base staffusers
        // migration already ships the realigned schema (nullable officeId,
        // role enum incl. 'instructor'), so there is nothing to realign.
        // See audit §3.2 / the add_auto_increment migration for the pattern.
