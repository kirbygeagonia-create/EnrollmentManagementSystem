            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Card title="Addresses" subtitle="At least one address is required">
                    {addresses.map((addr, idx) => (
                        <div key={idx} className="border border-brand-200 rounded-card p-4 mb-4">
                    ...
                    <button type="button" onClick={addAddress} className="btn btn-secondary btn-sm">
                ...
                <Card title="Educational Background" subtitle="Optional - for transferees and shifters">
                    {educationalBackgrounds.map((bg, idx) => (
                        <div key={idx} className="border border-brand-200 rounded-card p-4 mb-4">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                ...
                                <FormSection label="Honors/Certifications" className="sm:col-span-3">
                                    <textarea
                    ...
                    <button type="button" onClick={addEducationalBackground} className="btn btn-secondary btn-sm">
                        <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 4v16m8-8H4" />
                        </svg>
