...
export default function Curriculums({ curriculums, courses, majors }) {
    ...
    return (
        ...
        >
            ...
            <Modal show={showModal} onClose={closeModal} title={editingCurriculum ? 'Edit Curriculum' : 'Create Curriculum'}>
                <form onSubmit={handleSubmit}>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="form-group">
                            ...
                            />
                            {form.errors.majorId && <p className="form-error">{form.errors.majorId}</p>}
                        </div>
                        <div className="form-group">
                            <label className="form-label">Effective Year <span className="text-danger-500">*</span></label>
                            <input
                                type="date"
                                ...
                                required
                            />
                            {form.errors.effectiveYear && <p className="form-error">{form.errors.effectiveYear}</p>}
                        </div>
                        <div className="form-group md:col-span-2">
                            <label className="form-label">Curriculum Name <span className="text-danger-500">*</span></label>
                            <input
                                type="text"
                                ...
                                required
                            />
                            {form.errors.curriculumName && <p className="form-error">{form.errors.curriculumName}</p>}
                        </div>
                    </div>
